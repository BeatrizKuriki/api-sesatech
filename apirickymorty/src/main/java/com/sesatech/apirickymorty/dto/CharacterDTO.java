...
public class CharacterDTO implements Serializable{
	...
	public CharacterDTO(Long id, String name, StatusEnum status, String species, GenderEnum gender,String origin, String location, String imgUrl, Instant created) {
